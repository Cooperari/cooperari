...
public class CThreadScheduleBuilder {
  ...
  Runnable[] build() {
    ...
    IStepBarrier barrier;
    if (CSystem.inCooperativeMode()) 
      barrier = new CStepBarrier(numberOfThreads);
    else
      barrier = new PStepBarrier(numberOfThreads);
  ...
  public static class StepRunner implements Runnable {
     ...
     * Step barrier.
     */
    private final IStepBarrier barrier;
     ...
     */
    private StepRunner(List<Runnable> steps, IStepBarrier barrier) {
      this.steps = steps;
